...
# 项目根目录
# project_root = os.path.abspath(os.path.dirname(__file__))  # 或者使用项目的具体路径
# print("Project Root:", project_root)
# # model_cfg 的绝对路径
# model_cfg = "sam2_hiera_s.yaml"
# model_cfg_absolute = os.path.join(project_root, model_cfg)
# print("Model Config Absolute Path:", model_cfg_absolute)
...
for itr in range(100000):
    with torch.cuda.amp.autocast(): # cast to mix precision
        ...
        print("itr",itr, "Accuracy(Intersection over Union, IoU)=",mean_iou)
